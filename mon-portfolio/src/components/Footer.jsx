    ...
    >
      ...
      <div className="flex flex-col items-center gap-2 w-full max-w-lg px-4">
        ...
        <div className="flex gap-4 text-lg md:text-xl justify-center">
          <a href="https://github.com/SEBonduel" target="_blank" rel="noopener noreferrer" className="hover:text-green-500 transition z-[10001]">
            <FaGithub />
          </a>
          <a href="https://www.linkedin.com/in/s%C3%A9bastien-demange-5a4b03243/" target="_blank" rel="noopener noreferrer" className="hover:text-green-500 transition z-[10001]">
            <FaLinkedin />
          </a>
          <a href="mailto:sebastien050599@hotmail.fr" className="hover:text-green-500 transition z-[10001]">
            <FaEnvelope />
          </a>
        </div>
