...
export default function Skills() {
  return (
    <section className="p-8 z-[50] bg-[url('../Medias/Project_bg.jpg')] bg-cover bg-center bg-no-repeat font-medium font-orbitron pb-32 shadow-[0_20px_350px_rgba(0,0,0,1)]" id='Skills'>
      <h2 className="text-2xl md:text-4xl font-medium font-orbitron uppercase mb-12 mt-12 mb-8">Mes Compétences</h2>
